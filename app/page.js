      ...
      <section id="how-it-works" className="py-32 px-6 lg:px-8 bg-white relative">
        <div className="max-w-[1200px] mx-auto border-t border-gray-100 pt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
            ...
            >
              <div className="text-[#F3F4F6] text-[5rem] font-bold leading-none mb-6">01</div>
            ...
            >
              <div className="text-[#F3F4F6] text-[5rem] font-bold leading-none mb-6">02</div>
            ...
            <motion.div 
              ...
              className="flex flex-col relative"
            >
               <div className="text-[#F3F4F6] text-[5rem] font-bold leading-none mb-6">03</div>
      ...
      <section className="py-24 px-6 lg:px-8 bg-white">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative z-10">
            ...
            <Link 
              href="/demo" 
              className="w-full sm:w-auto bg-[#064E3B] border border-[#34D399]/30 text-white font-medium px-8 py-3.5 rounded-xl hover:bg-[#065F46] transition-colors duration-200 flex items-center justify-center text-[15px]"
            >
              View Demo
            </Link>
          </div>
